...
public class TestHelper {
    ...
    public static LwjglApplicationConfiguration createTestConfig() {
        ...
        config.width = ConfigurationConstants.SCREEN_WIDTH;
        config.height = ConfigurationConstants.SCREEN_HEIGHT;
        return config;
    }
    ...
    public static void changeScreen(final Screen targetScreen) {
        ...
        Gdx.app.postRunnable(() -> {
            Gdx.graphics.setWindowedMode(ConfigurationConstants.SCREEN_WIDTH, ConfigurationConstants.SCREEN_HEIGHT);
