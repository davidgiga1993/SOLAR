...
public class AstronomicalObjectsJUnit {
    ...
    private void runSetUp() {
        ...
        planet = CreateAnAstronomicalBody.named("Testplanet").whichHasTheFollowingOrbitalProperties(star, new Length(1.5f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(23, Angle.AngularUnit.DEGREE)).andHasTheFollowingBodyProperties(new Length(10000.4f / 2, Length.DistanceUnit.KILOMETERS), new Mass(0.5f, Mass.MassUnit.EARTH_MASS), new Albedo(0.3f)).whichRotatesEvery(new Time(0.99726968f, Time.TimeUnit.DAYS)).buildAs(new PlanetType(PlanetType.TypeOfPlanet.TERRESTRIAL, PlanetType.TextureTypeOfPlanet.TERRAN), solarSystem);
        CreateAnAstronomicalBody.named("Testmond").whichHasTheFollowingOrbitalProperties(planet, new Length(200000, Length.DistanceUnit.KILOMETERS), new Angle(-50, Angle.AngularUnit.DEGREE)).andHasTheFollowingBodyProperties(new Length(4879.4f / 2, Length.DistanceUnit.KILOMETERS), new Mass(0.1f, Mass.MassUnit.EARTH_MASS), new Albedo(0.3f)).whichIsTidallyLockedToItsPrimary().buildAs(new MoonType(MoonType.TypeOfMoon.TERRESTRIAL_MOON, MoonType.TextureTypeOfMoon.LUNAR), solarSystem);
        CreateAnAstronomicalBody.named("Testasteroid").whichHasTheFollowingOrbitalProperties(star, new Length(900, Length.DistanceUnit.KILOMETERS), new Angle(742, Angle.AngularUnit.DEGREE)).andHasTheFollowingBodyProperties(new Length(1500.4f / 2, Length.DistanceUnit.KILOMETERS), new Mass(20000, Mass.MassUnit.KILOGRAM), new Albedo(0.3f)).whichIsTidallyLockedToItsPrimary().buildAs(new AsteroidType(AsteroidType.TypeOfAsteroid.DTYPE, AsteroidType.TextureTypeOfAsteroid.PHOEBE_DEFAULT_IMAGE), solarSystem);
    }
