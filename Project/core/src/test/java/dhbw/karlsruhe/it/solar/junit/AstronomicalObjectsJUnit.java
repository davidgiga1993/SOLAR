...
public class AstronomicalObjectsJUnit
{
    ...
    public void runSetUp() {
    	...
    	planet = CreateAstronomicalBody.named("Testplanet").withOrbitalProperties(star, new Length(1.5f, Length.Unit.astronomicalUnit), new Angle(23)).andBodyProperties(new Length(10000.4f/2, Length.Unit.kilometres), new Mass(0.5f, Mass.Unit.EARTH_MASS)).buildAs(PlanetType.TERRAN, solarSystem);
    	CreateAstronomicalBody.named("Testmond").withOrbitalProperties(planet, new Length(200000, Length.Unit.kilometres), new Angle(-50)).andBodyProperties(new Length(4879.4f/2, Length.Unit.kilometres), new Mass(0.1f, Mass.Unit.EARTH_MASS)).buildAs(MoonType.LUNAR, solarSystem);
    	CreateAstronomicalBody.named("Testasteroid").withOrbitalProperties(star, new Length(900, Length.Unit.kilometres), new Angle(42)).andBodyProperties(new Length(1500.4f/2, Length.Unit.kilometres), new Mass(20000, Mass.Unit.KILOGRAM)).buildAs(AsteroidType.DTYPE, solarSystem);
    	}
