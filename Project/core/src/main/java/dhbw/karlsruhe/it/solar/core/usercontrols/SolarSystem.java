    ...
    public void createSolarSystem()
    {
    	...
    	star = CreateAstronomicalBody.named("Sun").withOrbitalProperties(this, new Length(0, Length.Unit.kilometres), new Angle(0)).andBodyProperties(new Length(1392684f/2, Length.Unit.kilometres), new Mass(1, Mass.Unit.SOLAR_MASS)).buildAs(StarType.GTypeMainSequence, this);
    		...
    		planet = CreateAstronomicalBody.named("Jupiter").withOrbitalProperties(star, new Length(5.20336301f, Length.Unit.astronomicalUnit), new Angle(120)).andBodyProperties(new Length(142984f/2, Length.Unit.kilometres), new Mass(318f, Mass.Unit.EARTH_MASS)).includingRings(new Mass((float)(0.22*Math.pow(10, 16)),Mass.Unit.KILOGRAM), new Length(226000,Length.Unit.kilometres), RingType.JOVIAN).buildAs( PlanetType.JOVIAN, this);
    			...
    			CreateAstronomicalBody.named("Leda").withOrbitalProperties(planet, new Length(11165000, Length.Unit.kilometres), new Angle(56)).andBodyProperties(new Length(20f/2, Length.Unit.kilometres), new Mass(1.09f*(float)(Math.pow(10,16)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
    			...
    			CreateAstronomicalBody.named("Ananke").withOrbitalProperties(planet, new Length(21276000, Length.Unit.kilometres), new Angle(90)).andBodyProperties(new Length(28f/2, Length.Unit.kilometres), new Mass(3.0f*(float)(Math.pow(10,16)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
    			CreateAstronomicalBody.named("Carme").withOrbitalProperties(planet, new Length(23404000, Length.Unit.kilometres), new Angle(-70)).andBodyProperties(new Length(46f/2, Length.Unit.kilometres), new Mass(1.3f*(float)(Math.pow(10,17)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
    			CreateAstronomicalBody.named("Pasiphea").withOrbitalProperties(planet, new Length(23624000, Length.Unit.kilometres), new Angle(-90)).andBodyProperties(new Length(56f/2, Length.Unit.kilometres), new Mass(1.92f*(float)(Math.pow(10,17)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
    			CreateAstronomicalBody.named("Sinope").withOrbitalProperties(planet, new Length(23939000, Length.Unit.kilometres), new Angle(-115)).andBodyProperties(new Length(38f/2, Length.Unit.kilometres), new Mass(7.77f*(float)(Math.pow(10,16)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
    		planet = CreateAstronomicalBody.named("Saturn").withOrbitalProperties(star, new Length(9.53707032f, Length.Unit.astronomicalUnit), new Angle(-130)).andBodyProperties(new Length(120536f/2, Length.Unit.kilometres), new Mass(95f, Mass.Unit.EARTH_MASS)).includingRings(new Mass((float)(3*Math.pow(10, 19)),Mass.Unit.KILOGRAM), new Length(140550,Length.Unit.kilometres), RingType.SATURNIAN).buildAs(PlanetType.SATURNIAN, this);
	    		...
	    		CreateAstronomicalBody.named("Epimetheus").withOrbitalProperties(planet, new Length(151410, Length.Unit.kilometres), new Angle(75)).andBodyProperties(new Length(116f/2, Length.Unit.kilometres), new Mass(0.00000009f, Mass.Unit.EARTH_MASS)).buildAs(MoonType.IRREGULAR, this);
	    		...
	    		CreateAstronomicalBody.named("Telesto").withOrbitalProperties(planet, new Length(294619, Length.Unit.kilometres), new Angle(150)).andBodyProperties(new Length(24.8f/2, Length.Unit.kilometres), new Mass(4.0464f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
	    		CreateAstronomicalBody.named("Calypso").withOrbitalProperties(planet, new Length(294619, Length.Unit.kilometres), new Angle(30)).andBodyProperties(new Length(21.4f/2, Length.Unit.kilometres), new Mass(2.5477f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
	    		...
	    		CreateAstronomicalBody.named("Helene").withOrbitalProperties(planet, new Length(377396, Length.Unit.kilometres), new Angle(47)).andBodyProperties(new Length(35.2f/2, Length.Unit.kilometres), new Mass(11f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
	    		...
	    		CreateAstronomicalBody.named("Phoebe").withOrbitalProperties(planet, new Length(12955759, Length.Unit.kilometres), new Angle(-100)).andBodyProperties(new Length(212f/2, Length.Unit.kilometres), new Mass(0.00000139f, Mass.Unit.EARTH_MASS)).buildAs(MoonType.IRREGULAR, this);
	    		...
	    		CreateAstronomicalBody.named("Ymir").withOrbitalProperties(planet, new Length(23130000, Length.Unit.kilometres), new Angle(90)).andBodyProperties(new Length(18f/2, Length.Unit.kilometres), new Mass(4.9f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
			planet = CreateAstronomicalBody.named("Uranus").withOrbitalProperties(star, new Length(19.19126393f, Length.Unit.astronomicalUnit), new Angle(20)).andBodyProperties(new Length(51118f/2, Length.Unit.kilometres), new Mass(14f, Mass.Unit.EARTH_MASS)).includingRings(new Mass((float)(0.9*Math.pow(10, 16)),Mass.Unit.KILOGRAM), new Length(100000,Length.Unit.kilometres), RingType.URANIAN).buildAs(PlanetType.URANIAN, this);
				...
				CreateAstronomicalBody.named("Francisco").withOrbitalProperties(planet, new Length(4275910, Length.Unit.kilometres), new Angle(15)).andBodyProperties(new Length(22f/2, Length.Unit.kilometres), new Mass(7.2f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				CreateAstronomicalBody.named("Caliban").withOrbitalProperties(planet, new Length(7164900, Length.Unit.kilometres), new Angle(-70)).andBodyProperties(new Length(72f/2, Length.Unit.kilometres), new Mass(7.3f*(float)(Math.pow(10,17)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				CreateAstronomicalBody.named("Stephano").withOrbitalProperties(planet, new Length(7952320, Length.Unit.kilometres), new Angle(160)).andBodyProperties(new Length(32f/2, Length.Unit.kilometres), new Mass(6.0f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				CreateAstronomicalBody.named("Trinculo").withOrbitalProperties(planet, new Length(8501260, Length.Unit.kilometres), new Angle(140)).andBodyProperties(new Length(18f/2, Length.Unit.kilometres), new Mass(3.9f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				CreateAstronomicalBody.named("Sycorax").withOrbitalProperties(planet, new Length(12179000, Length.Unit.kilometres), new Angle(0)).andBodyProperties(new Length(150f / 2, Length.Unit.kilometres), new Mass(0.00000039f, Mass.Unit.EARTH_MASS)).buildAs(MoonType.IRREGULAR, this);
				...
				CreateAstronomicalBody.named("Prospero").withOrbitalProperties(planet, new Length(16162240, Length.Unit.kilometres), new Angle(-110)).andBodyProperties(new Length(50f/2, Length.Unit.kilometres), new Mass(8.5f*(float)(Math.pow(10,16)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				CreateAstronomicalBody.named("Setebos").withOrbitalProperties(planet, new Length(17419270, Length.Unit.kilometres), new Angle(120)).andBodyProperties(new Length(47f/2, Length.Unit.kilometres), new Mass(7.5f*(float)(Math.pow(10,16)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				CreateAstronomicalBody.named("Ferdinand").withOrbitalProperties(planet, new Length(20507100, Length.Unit.kilometres), new Angle(90)).andBodyProperties(new Length(21f/2, Length.Unit.kilometres), new Mass(5.4f*(float)(Math.pow(10,15)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
			planet = CreateAstronomicalBody.named("Neptune").withOrbitalProperties(star, new Length(30.06896348f, Length.Unit.astronomicalUnit), new Angle(-30)).andBodyProperties(new Length(49528f/2, Length.Unit.kilometres), new Mass(17f, Mass.Unit.EARTH_MASS)).includingRings(new Mass((float)(0.8*Math.pow(10, 15)),Mass.Unit.KILOGRAM), new Length(63732,Length.Unit.kilometres), RingType.NEPTUNIAN).buildAs(PlanetType.NEPTUNIAN, this);
				...
				CreateAstronomicalBody.named("Triton").withOrbitalProperties(planet, new Length(354759, Length.Unit.kilometres), new Angle(-130)).andBodyProperties(new Length(2707f / 2, Length.Unit.kilometres), new Mass(0.00358f, Mass.Unit.EARTH_MASS)).buildAs(MoonType.TRITONIAN, this);
				...
				CreateAstronomicalBody.named("Halimede").withOrbitalProperties(planet, new Length(16589670, Length.Unit.kilometres), new Angle(99)).andBodyProperties(new Length(62f/2, Length.Unit.kilometres), new Mass(8.9920f*(float)(Math.pow(10,16)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				...
				CreateAstronomicalBody.named("Psamathe").withOrbitalProperties(planet, new Length(46695000, Length.Unit.kilometres), new Angle(145)).andBodyProperties(new Length(38f/2, Length.Unit.kilometres), new Mass(1.4987f*(float)(Math.pow(10,16)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
				CreateAstronomicalBody.named("Neso").withOrbitalProperties(planet, new Length(49285000, Length.Unit.kilometres), new Angle(0)).andBodyProperties(new Length(60f/2, Length.Unit.kilometres), new Mass(2.6485f*(float)(Math.pow(10,17)), Mass.Unit.KILOGRAM)).buildAs(MoonType.IRREGULAR, this);
