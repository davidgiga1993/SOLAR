...
public class SolarSystem extends AstronomicalBody {
    ...
    public void createSolarSystem()
    {
    	...
    	star = placeNewStar("Sun", new Length(1392684f/2, Length.Unit.kilometres), 1, 0, 0);
    		planet = star.placeNewPlanet("Mercury", PlanetType.BARREN, new Length(4879.4f/2, Length.Unit.kilometres), 0.055, 0.38709893, 170);
			planet = star.placeNewPlanet("Venus", PlanetType.HOTHOUSE, new Length(12103.6f/2, Length.Unit.kilometres), 0.815, 0.72333199, -45);
    		...
    		planet = star.placeNewPlanet("Neptune", PlanetType.ICEGIANT, new Length(49528f/2, Length.Unit.kilometres), 17, 30.06896348, -30);
				planet.placeNewMoon("Triton", new Length(2707f/2, Length.Unit.kilometres), 0.00358, 354759, 90);
	    	planet = star.placeNewPlanet("Pluto", PlanetType.DWARFPLANET, new Length(2310f/2, Length.Unit.kilometres), 0.0022, 39.482, -80);
	    		planet.placeNewMoon("Charon", new Length(1207f/2, Length.Unit.kilometres), 0.00025, 17536, 90);
	    	star.placeNewPlanet("Haumea", PlanetType.DWARFPLANET, new Length(1600f/2, Length.Unit.kilometres), 0.0007,  43.335, 0);
	    	star.placeNewPlanet("Makemake", PlanetType.DWARFPLANET, new Length(1500f/2, Length.Unit.kilometres), 0.0003, 45.792, 0);
	    	star.placeNewPlanet("Eris", PlanetType.DWARFPLANET, new Length(2326f/2, Length.Unit.kilometres), 0.0028, 67.668, 0);
    }
