    ...
    public void createSolarSystem()
    {
    	...
    	star = placeNewStar("Sun", new Length(1392684f/2, Length.Unit.kilometres), 1, 0, 0);
    		...
    		planet = star.placeNewPlanet("Uranus", new Length(51118f/2, Length.Unit.kilometres), 14, 19.19126393, 20, PlanetType.URANIAN);
				planet.placeNewMoon("Ariel", new Length(1158f/2, Length.Unit.kilometres), 0.00022, 190900, 90, MoonType.LUNAR);
				planet.placeNewMoon("Umbriel", new Length(1169f/2, Length.Unit.kilometres), 0.0002, 266000, 90, MoonType.LUNAR);
				planet.placeNewMoon("Titania", new Length(1578f/2, Length.Unit.kilometres), 0.0006, 436300, 90, MoonType.LUNAR);
				planet.placeNewMoon("Oberon", new Length(1523f/2, Length.Unit.kilometres), 0.00046, 583519, 90, MoonType.LUNAR);
				planet.placeNewMoon("Miranda", new Length(472f/2, Length.Unit.kilometres), 0.00001,  129390, 90, MoonType.LUNAR);
    		planet = star.placeNewPlanet("Neptune", new Length(49528f/2, Length.Unit.kilometres), 17, 30.06896348, -30, PlanetType.NEPTUNIAN);
				planet.placeNewMoon("Triton", new Length(2707f/2, Length.Unit.kilometres), 0.00358, 354759, 90, MoonType.LUNAR);
	    	planet = star.placeNewPlanet("Pluto", new Length(2310f/2, Length.Unit.kilometres), 0.0022, 39.482, -80, PlanetType.DWARFPLANET);
	    		planet.placeNewMoon("Charon", new Length(1207f/2, Length.Unit.kilometres), 0.00025, 17536, 90, MoonType.LUNAR);
