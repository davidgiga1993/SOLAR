...
public class SolarSystem extends AstronomicalBody {
    ...
    public void createSolarSystem()    {
        ...
        star = CreateAnAstronomicalBody.named("Sun").whichIsStationaryAt(this).andHasTheFollowingBodyProperties(new Length(1392684f / 2, Length.DistanceUnit.KILOMETERS), new Mass(1, Mass.MassUnit.SOLAR_MASS), new Albedo(1f)).withAGasGiantAtmosphereOf(createPhotosphereOfSun()).buildAs(new StarType(StarType.MorganKeenanSpectralType.G, StarType.SpectralTypeSubdivision.TWO, StarType.LuminosityClass.MAIN_SEQUENCE_STAR), this);
            CreateAnAstronomicalBody.named("Mercury").whichHasTheFollowingOrbitalProperties(star, new Length(0.38709893f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(170)).andHasTheFollowingBodyProperties(new Length(4879.4f / 2, Length.DistanceUnit.KILOMETERS), new Mass(0.055f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.068f)).whichIsTidallyLockedToItsStar().withAnAtmosphereOf(new Pressure((float)Math.pow(10,-14), PressureUnit.BAR), createAtmosphereOfMercury()).buildAs(new PlanetType(PlanetType.TypeOfPlanet.MERCURIAN), this);
            ...
            planet = CreateAnAstronomicalBody.named("Earth").whichHasTheFollowingOrbitalProperties(star, new Length(1f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(-120)).andHasTheFollowingBodyProperties(new Length(12756.32f / 2, Length.DistanceUnit.KILOMETERS), new Mass(1f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.306f)).withOceanCoverAndIceCapOf(0.608f, 0.1f).withAnAtmosphereOf(new Pressure(101.325f,PressureUnit.KILOPASCAL), createAtmosphereOfEarth()).addBiosphere(BiosphereType.TERRAN, 0.9f).buildAs(new PlanetType(PlanetType.TypeOfPlanet.TERRAN), this);
                CreateAnAstronomicalBody.named("Moon").whichHasTheFollowingOrbitalProperties(planet, new Length(384399, Length.DistanceUnit.KILOMETERS), new Angle(-30)).andHasTheFollowingBodyProperties(new Length(3476f / 2, Length.DistanceUnit.KILOMETERS), new Mass(0.0123f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.136f)).buildAs(new MoonType(MoonType.TypeOfMoon.LUNAR), this);
            ...
            planet = CreateAnAstronomicalBody.named("Jupiter").whichHasTheFollowingOrbitalProperties(star, new Length(5.20336301f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(120)).andHasTheFollowingBodyProperties(new Length(142984f / 2, Length.DistanceUnit.KILOMETERS), new Mass(318f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.343f)).withAGasGiantAtmosphereOf(createAtmosphereOfJupiter()).includingRings(new Mass((float)(0.22*Math.pow(10, 16)),Mass.MassUnit.KILOGRAM), new Length(92000, Length.DistanceUnit.KILOMETERS), new Length(226000,Length.DistanceUnit.KILOMETERS), RingType.JOVIAN).buildAs(new PlanetType(PlanetType.TypeOfPlanet.JOVIAN), this);
            ...
            planet = CreateAnAstronomicalBody.named("Saturn").whichHasTheFollowingOrbitalProperties(star, new Length(9.53707032f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(-130)).andHasTheFollowingBodyProperties(new Length(120536f / 2, Length.DistanceUnit.KILOMETERS), new Mass(95f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.342f)).withAGasGiantAtmosphereOf(createAtmosphereOfSaturn()).includingRings(new Mass((float)(3*Math.pow(10, 19)),Mass.MassUnit.KILOGRAM), new Length(66900, Length.DistanceUnit.KILOMETERS),  new Length(140550,Length.DistanceUnit.KILOMETERS), RingType.SATURNIAN).buildAs(new PlanetType(PlanetType.TypeOfPlanet.SATURNIAN), this);
            ...
            planet = CreateAnAstronomicalBody.named("Uranus").whichHasTheFollowingOrbitalProperties(star, new Length(19.19126393f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(20)).andHasTheFollowingBodyProperties(new Length(51118f / 2, Length.DistanceUnit.KILOMETERS), new Mass(14f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.30f)).withAGasGiantAtmosphereOf(createAtmosphereOfUranus()).includingRings(new Mass((float) (0.9 * Math.pow(10, 16)), Mass.MassUnit.KILOGRAM), new Length(26840, Length.DistanceUnit.KILOMETERS), new Length(100000, Length.DistanceUnit.KILOMETERS), RingType.URANIAN).buildAs(new PlanetType(PlanetType.TypeOfPlanet.URANIAN), this);
            ...
            planet = CreateAnAstronomicalBody.named("Neptune").whichHasTheFollowingOrbitalProperties(star, new Length(30.06896348f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(-30)).andHasTheFollowingBodyProperties(new Length(49528f / 2, Length.DistanceUnit.KILOMETERS), new Mass(17f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.29f)).withAGasGiantAtmosphereOf(createAtmosphereOfNeptune()).includingRings(new Mass((float)(0.8*Math.pow(10, 15)),Mass.MassUnit.KILOGRAM), new Length(40900, Length.DistanceUnit.KILOMETERS), new Length(63732,Length.DistanceUnit.KILOMETERS), RingType.NEPTUNIAN).buildAs(new PlanetType(PlanetType.TypeOfPlanet.NEPTUNIAN), this);
