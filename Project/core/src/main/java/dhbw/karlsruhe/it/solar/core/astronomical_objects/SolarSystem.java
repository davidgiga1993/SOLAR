...
public class SolarSystem extends AstronomicalBody {
    ...
    public void createSolarSystem()    {
        ...
        star = CreateAnAstronomicalBody.named("Sun").whichIsStationaryAt(this).andHasTheFollowingBodyProperties(new Length(1392684f / 2, Length.DistanceUnit.KILOMETERS), new Mass(1, Mass.MassUnit.SOLAR_MASS), new Albedo(1f)).whichRotatesEvery(new Time(25.05f,TimeUnit.DAYS)).withAGasGiantAtmosphereOf(createPhotosphereOfSun()).buildAs(new StarType(StarType.MorganKeenanSpectralType.G, StarType.SpectralTypeSubdivision.TWO, StarType.LuminosityClass.MAIN_SEQUENCE_STAR), this);
            ...
            planet = CreateAnAstronomicalBody.named("Neptune").whichHasTheFollowingOrbitalProperties(star, new Length(30.06896348f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(-30)).andHasTheFollowingBodyProperties(new Length(49528f / 2, Length.DistanceUnit.KILOMETERS), new Mass(17.147f, Mass.MassUnit.EARTH_MASS),  new Albedo(0.29f)).whichRotatesEvery(new Time(0.6713f,TimeUnit.DAYS)).withAGasGiantAtmosphereOf(createAtmosphereOfNeptune()).includingRings(new Mass((float)(0.8*Math.pow(10, 15)),Mass.MassUnit.KILOGRAM), new Length(40900, Length.DistanceUnit.KILOMETERS), new Length(63732,Length.DistanceUnit.KILOMETERS), RingType.NEPTUNIAN).buildAs(new PlanetType(PlanetType.TypeOfPlanet.NEPTUNIAN), this);
            ...
            CreateAnAstronomicalBody.named("Makemake").whichHasTheFollowingOrbitalProperties(star, new Length(45.792f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(-125)).andHasTheFollowingBodyProperties(new Length(1500f / 2, Length.DistanceUnit.KILOMETERS), new Mass(0.0003f, Mass.MassUnit.EARTH_MASS), new Albedo(0.81f)).whichRotatesEvery(new Time(7.771f,TimeUnit.HOURS)).buildAs(new PlanetType(PlanetType.TypeOfPlanet.DWARFPLANET), this);
            planet = CreateAnAstronomicalBody.named("Eris").whichHasTheFollowingOrbitalProperties(star, new Length(67.668f, Length.DistanceUnit.ASTRONOMICAL_UNITS), new Angle(80)).andHasTheFollowingBodyProperties(new Length(2326f / 2, Length.DistanceUnit.KILOMETERS), new Mass(0.0028f, Mass.MassUnit.EARTH_MASS), new Albedo(0.96f)).whichRotatesEvery(new Time(25.9f,TimeUnit.HOURS)).buildAs(new PlanetType(PlanetType.TypeOfPlanet.DWARFPLANET), this);
